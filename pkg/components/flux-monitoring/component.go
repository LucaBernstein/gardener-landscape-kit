...
const (
	// ComponentName is the name of the flux-monitoring component.
	ComponentName = "flux-monitoring"
	// ComponentDirectory is the directory of the flux-monitoring component within the base components directory.
	ComponentDirectory = "flux-monitoring"
)
...
// NewComponent creates a new flux-monitoring component.
